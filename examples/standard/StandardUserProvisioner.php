...
class StandardUserProvisioner implements UserProvisionerInterface
{
    public function provision(ExternalIdentity $identity, AuthContext $context): Authenticatable
    {
        return User::create(['name' => $identity->name ?: $identity->email, 'email' => $identity->email, 'password' => Hash::make(Str::random(64))]);
    }
}
