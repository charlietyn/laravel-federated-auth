...
class NullUserProvisioner implements UserProvisionerInterface
{
    public function provision(ExternalIdentity $identity, AuthContext $context): Authenticatable
    {
        throw new UserProvisioningNotConfiguredException('Auto provisioning is enabled but no UserProvisionerInterface implementation was configured.');
    }
}
