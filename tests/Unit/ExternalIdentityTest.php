...
{
    public function test_it_detects_required_missing_email(): void
    {
        ...
        $this->assertTrue($identity->requiresEmailButMissing(true));
        $this->assertFalse($identity->requiresEmailButMissing(false));
    }
}
